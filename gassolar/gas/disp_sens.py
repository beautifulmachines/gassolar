...
if __name__ == "__main__":
    ...
    varnames = [
        "V_{wind}_Mission/Loiter/FlightSegment",
        "W_{pay}",
        "\\eta_{prop}",
        "BSFC_{min}",
        "t_Mission/Loiter",
    ...
    if len(sys.argv) > 1:
        ...
        sens_table(
            ...
            latns=latns,
            title="Gas Powered Aircraft Sensitivities " "(90th Percentile Winds)",
            label="gassens",
        )
        sol_table(
            sols,
            ...
            ttype="gas",
            latns=dlatns,
            title="Gas Powered Aircraft Design Variables",
            label="gvals",
        )
        sol_table(
            tbsols,
        ...
        sens_table(
            ...
            varnames,
            solar=False,
            filename="gassens.generated.tex",
            latns=latns,
            title="Gas Powered Aircraft Sensitivities " "(90th Percentile Winds)",
        )
        sol_table(
        ...
        sol_table(
            ...
            tbfvar,
            ttype="tbflexg",
            filename="tbfgtable.generated.tex",
            latns=tbflat,
            title="Tail Boom Flexibility with Solar Model",
            label="tbfgtable",
        )
